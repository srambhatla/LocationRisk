# This script is used to generate checkin and infection events per cluster using the infec-stat-res file. 
# Sirisha Rambhatla, July 2020
...
parser.add_argument('--infect_stat_folder', type=str)
parser.add_argument('--latent_days', type=int, default=5)
#parser.add_argument('--seed', type=int, default=0)
parser.add_argument('--resroot', type=str)


args = parser.parse_args()


# python3 create_mobility.py --month 'dec' --city 'LA' --clusters 15 --infect_stat_file '<path to infect_stat_res.txt>' --resroot '<path-to-results>'
